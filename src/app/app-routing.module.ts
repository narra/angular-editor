...
const routes: Routes = [
  ...
  {path: 'projects/:name/metadata', component: ProjectsMetadataComponent, canActivate: [AuthGuard], data: {roles: [narra.RoleType.author]}},
  ...
  {path: 'libraries/:id/metadata', component: LibrariesMetadataComponent, canActivate: [AuthGuard], data: {roles: [narra.RoleType.author]}},
  ...
  {path: 'items/:id/metadata', component: ItemsMetadataComponent, canActivate: [AuthGuard], data: {roles: [narra.RoleType.author]}},
